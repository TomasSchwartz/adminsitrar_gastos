        ...
        <div className={`min-h-screen flex items-center justify-center px-4 py-12 transition-colors duration-300 ${
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className={`absolute top-0 left-0 w-full h-full opacity-5 ${
                    ...
                    <div
                        className="absolute top-1/3 left-1/3 w-96 h-96 bg-emerald-500 rounded-full mix-blend-multiply filter blur-xl opacity-20"></div>
                    <div
                        className="absolute top-2/3 right-1/3 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl opacity-20"></div>
                    <div
                        className="absolute top-1/2 left-1/2 w-96 h-96 bg-indigo-500 rounded-full mix-blend-multiply filter blur-xl opacity-15"></div>
                </div>
            </div>
                    ...
                    <div className="p-8">
                        ...
                        <div className={`mt-6 pt-4 border-t transition-colors duration-300 ${
                            ...
                            <div className="flex items-center justify-center space-x-1">
                                <svg className={`w-4 h-4 ${dark ? 'text-emerald-400' : 'text-emerald-500'}`} fill="none"
